...
public class RealizarBusqueda extends PageObject {
    public static Target INPUT_BUSCADOR_GOOGLE = Target.the("Buscador de google").locatedBy("//div[@class='SDkEP']/div[2]/input");
    ...
    public static Target TITULO = Target.the("Titulo obtenido que me permite realizar scroll").locatedBy("//h3/span[contains(text(), 'Prehistoria')]");
